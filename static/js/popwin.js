...
showWin: function(width, height, bond_code) {
        ...
        inntHtml += '</div>'
        inntHtml += '<iframe id = "pop_win_frame" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + 'http://quote.eastmoney.com/bond/' + bond_code + '.html' + '"></iframe>';
